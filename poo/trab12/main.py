...
class LimitePrincipal():
    def __init__(self, root, controle):
        ...
        self.estudanteMenu.add_command(label='Consultar', \
                    command=self.controle.consultarEstudante)
        ...
        self.discipMenu.add_command(label='Consultar', \
                    command=self.controle.consultarDisciplina)    
        ...
        self.turmaMenu.add_command(label='Consultar', \
                    command=self.controle.consultarTurmas)               
...
class ControlePrincipal():       
    ...
    def consultarEstudante(self):
        self.ctrlEstudante.consultarEstudante()
