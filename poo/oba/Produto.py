    ...
    def consultar(self, event):
        ...
        try:
            ...
            self.limiteConsulta.mostraMessagebox('Consulta', 'PRODUTO ENCONTRADO\n\nCodigo: {} \nDescrição: {} \
                \nValor Unitário: R$ {}\n'.format(produto.codigo, produto.descricao, produto.valorUnitario), True)
        finally:
            self.clearConsulta(event)
            
    def clearConsulta(self, event):
        self.limiteConsulta.inputCodigo.delete(0, len(self.limiteConsulta.inputCodigo()))
